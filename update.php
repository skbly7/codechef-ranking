...
<?php include "files/nav.php";?>
	...
	<div class="main">		
		...
		<div class="content">
    <h1>Update an old Username</h1><br />
	...
	$error=0;
      $i=rand(100000,999999);
		if($error==2){ 
    ?><br>
    <div style="background-color:rgba(247, 6, 6, 0.5);border-radius:30px;border:4px white solid;margin-bottom:30px;color:white;font-size:25px;padding:2px;"><img style="margin-top:1px;" src="img/error.png"/> Unknown error. Please report problem using report a bug option</div>
    <?php } else if($error==1){?>
    ...
    <?php } else if($error==4) {?>
    <div style="background-color:rgba(247, 6, 6, 0.5);border-radius:30px;border:4px white solid;margin-bottom:30px;color:white;font-size:25px;padding:2px;"><img style="margin-top:1px;" src="img/error.png"/> It was almost updated..! <a href="update.php?error=4&read=1">Read more</a></div>
    <?php
    $sno=1;
    if($_GET['read']==1)
    {
    echo "<h4>Any of the following word should appear in your Codechef's profile Institute field after updation :<br/>";
    ...
    <?php } else if($error==9) {?>
    <div style="background-color:rgba(6, 73, 247, 0.5);border-radius:30px;border:4px white solid;margin-bottom:30px;color:white;font-size:25px;padding:2px;"><img style="margin-top:1px;" src="img/success.png"/> User "<?php echo $_GET['user']; ?>" updated successfully.</div>
    <?php }?>
    <form name="input" action="updater.php" method="get">
